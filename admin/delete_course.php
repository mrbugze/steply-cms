...
// Check if the course exists before attempting deletion
$stmtCheck = $conn->prepare("SELECT course_id FROM courses WHERE course_id = :course_id");
...
try {
    ...
    $stmtDelete = $conn->prepare("DELETE FROM courses WHERE course_id = :course_id");
